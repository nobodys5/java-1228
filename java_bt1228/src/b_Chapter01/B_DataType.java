...
//		2-1. 정수 타입
//		byte: 8비트 1바이트 정수 - 값의 범위(-128 ~ 127)
//		short: 16비트 2바이트 정수 - 값의 범위(-32,768 ~ 32,767)
//		int(기본): 32비트 4바이트 정수 - 값의 범위(약-2.1억 ~ 약2.1억)
//		long: 64비트 8바이트 정수 - 값의 범위(약-2의 63제곱 ~ 약2의 63제곱)
		int age;
		age = 27;
		System.out.println(age);
		
//		long 데이터 타입은 숫자 뒤에 알파벳 L 또느 l을 써서 long형임을 표시
...
//		float(기본): 4바이트 소수점, 숫자 뒤에 알파벳 F를 써서 float형임을 표시
